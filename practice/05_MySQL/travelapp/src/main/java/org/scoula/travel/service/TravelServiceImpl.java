...
@RequiredArgsConstructor // final이 붙은 필드를 받아오는 생성자
public class TravelServiceImpl implements TravelService {
    ...
    private void printTravels(List<TravelVO> travels) {
        for (TravelVO travel: travels) {
            System.out.printf("%3d %6s  %s\n", travel.getNo(), travel.getDescription(), travel.getTitle());
        }
    }
    ...
    public void printTravel() {
        ...
        // 값이 없을 경우 NoSuchElementException 예외 처리
